...
st.markdown('<h1 style="font-size: 40px; font-weight: bold;"> Backbone Curve and Damage States</h1>', unsafe_allow_html=True)
...
print("The R2 value for Test Set for RF is :",r2_score(y_pred,y_test))
print("The R2 value for Train Set for RF is :",r2_score(y_pred_train,y_train))
